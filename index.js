...
const ownerNumber = ['254705244235']
...
let up = `*╭──────────────●●►*
> *The-Great ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ ${prefix}ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ✅*
...
*╭⊱✫🐲 The-Great 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *The-Great*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *Samuel Muli*
*│✫➠ - 🌐URL:* *https://github.com/Samuel-Muli*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://qu.ax/SnaGx.jpg` }, caption: up })
...
//================ownerreact==============
/* if(senderNumber.includes("254705244235")){
if(isReact) return
m.react("")
}
...
/* if(senderNumber.includes("254710672541")){
if(isReact) return
m.react("💕")//
   } */
...
app.get("/", (req, res) => {
res.send("HEY, The-Great STARTED ✅");
});
