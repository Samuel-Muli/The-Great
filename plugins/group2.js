...
cmd({
    ...
    try {
        ...
        const channelLink = "https://chat.whatsapp.com/FV96nX6l7iCGmBeunOFPa0";

        // Send the channel link to the user
        reply(`Here's 💁🏽 the link to my official WhatsApp Group:\n\n${channelLink}\n\n> Join us to stay updated with the latest news and announcements🧞‍♂️.`);
    } catch (error) {
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://chat.whatsapp.com/FV96nX6l7iCGmBeunOFPa0";
